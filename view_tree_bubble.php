...
<div class="container-app">
  <div class="header">
    ...
    <div class="controls">
      <a href="admin_main.php" class="btn btn-sm btn-warning me-2"><i class="fa fa-arrow-left"></i> Back</a>

      <form id="searchForm" class="d-flex" onsubmit="event.preventDefault(); goSearch();">
        <input id="mlm_input" class="form-control form-control-sm" style="min-width:180px" placeholder="Member ID (eg. DE00001)" value="<?= isset($member['mlm_id'])?h($member['mlm_id']):'' ?>" required>
  ...
  <div id="canvas" class="canvas">
    ...
    <?php if (!$member): ?>
      <div class="text-center py-5">
        <p class="hint">Enter a member ID and press <b>Go</b> to render the bubble tree. Children are loaded lazily to keep UI snappy.</p>
      </div>
    <?php else: ?>
